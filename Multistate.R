...
#JAGS model: covariates on adult and juvenile parameters (no effort, assuming constant transition rates)	
...
#-----------------------------------------------------------------------------------------------# 
# Run multistate model in JAGS, with covariates (including effort) and random site effects
#-----------------------------------------------------------------------------------------------#	
#Prep data objects for JAGS
  ntorts <- nrow(cr.mat)             #number of tortoises
  nyears <- ncol(cr.mat)             #number of occasions
